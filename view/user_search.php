...
<div class="container pb-6 pt-6">
    <?php
        ...
        //Si la variable $_POST['modulo_buscador'] está definida, significa que se ha enviado el formulario
    ...
    <div class="columns">
        <div class="column">
            <form action="" method="post" autocomplete="off" >
                <!-- Cuando action está vacio los datos se envian a la misma página-->
